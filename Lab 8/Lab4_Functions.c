...
// function to send any single command to the LCD
        ...
        // function with hardcodded values meant to initialize the LCD
         ...
         void SRAMWRITE(int16 data, Uint32 address){
             ...
             Uint32 ramaddr  = (address - 0x40000); // this will be the modified ram address for the 2nd ram module
         ...
         Uint16 SRAMREAD(Uint32 address){
             ...
             Uint16 volatile SRAMdataH;
             Uint16 volatile SRAMdataL;
             ...
             // send the data
             SRAMdataH = SPITRANSMIT(transfer); // extra dummy cycle
             SRAMdataH = SPITRANSMIT(transfer);
             SRAMdataL = SPITRANSMIT(transfer);
             SRAMdata = ((SRAMdataH << 8) | SRAMdataL);
