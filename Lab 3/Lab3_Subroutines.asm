;****************************************************************************************
; Lab3_Subroutines.asm
; Ryan Simoneau
; Last Modified: Feb, 07 2021
;
; Description: This program is a test file for subroutines used in lab 3 part 3
;
;
...
TESTT		LC		Initialize_LCD
			MOV		AR0,#0x52
			LC		Write_Data_Reg


		; This is code ment to test I2C info, init, and end together
;I2CC	; continuously loops through timing diagram for debugging purposes
		;LC		I2C_INIT
		...
		; This is code to test the WAIT subroutine.
		;MOV		AL,#0x0100 ; put 1 where pin 104 is before loop
;FVL:	LC		WAIT

		;MOV		AR0,#GPDTOGGLEL
		;MOV		*AR0,AL

		;B		FVL,UNC ; stay in this loop forever for testing purposes
