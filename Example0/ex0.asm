...
char    .byte    	'E' 		;define string, ASCII characters placed in memory as WORDS!
        ...
        .byte    	'1'
        .byte    	'1'
		.byte 		"2021" ;here is another way to specify a string of WORDS!
		.word 		0xabcd ;another way to specify a hex number (WORD)
val1 	.word 		32 ;places 32 decimal (20 hex) in memory (WORD)
